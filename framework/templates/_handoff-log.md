---
title: "Handoff log — <project>"
tags: [<project>, coordination, handoff, progress-log]
status: "Append-only ping board for every CS + CC session and every teammate. Newest-at-top in your
own section, stamp every entry, keep entries ONE line (a no-merge cloud drive clobbers long rewrites).
Claim shared files on the ACTIVE EDITS board before editing. Re-read before you append."
---
