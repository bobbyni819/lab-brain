...
>
> It's generalized from a system our lab already runs in production — a multi-person spatial-omics
> project and a Data+ undergraduate team. The showcased capability even reads *figure panels*: it
> recovered a 29-fold value that appears nowhere in a paper's text, and flagged a figure whose value
> contradicts the text. Open source (MIT).
